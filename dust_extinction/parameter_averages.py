...
__all__ = ['CCM89', 'O94', 'F99', 'F04', 'G16', 'MA14']
...
class MA14(BaseExtRvModel):

    """
    MA14 extinction model calculation
    ...
    R5495: float
        ...
        Spectral equivalent to R(V), canonical value is 3.1
    ...
    Notes
    -----
    MA14 Galactic R(V) dependent model
    ...
    Example showing MA14 curves for a range of R5495 values.
    ...
    .. plot::
        ...
        from dust_extinction.parameter_averages import MA14
